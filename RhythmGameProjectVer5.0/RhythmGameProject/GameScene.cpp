...
{
	if (Input::GetInstance().IsPressed(eGameKey::VOL_UP))
	{
		GameSystem::GetInstance()->IncreaseVolume();
	}
	else if (Input::GetInstance().IsPressed(eGameKey::VOL_DOWN))
	{
		GameSystem::GetInstance()->DecreaseVolume();
	}
	else if (Input::GetInstance().IsPressed(eGameKey::SPEED_DOWN))
	{
		GameSystem::GetInstance()->DecreaseTrackHeight();
	}
	else if (Input::GetInstance().IsPressed(eGameKey::SPEED_UP))
	{
